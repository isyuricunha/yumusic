...
import com.yuricunha.yumusic.repository.DownloadRepository;
...
public class DownloaderManager {
    ...
    public void download(MediaItem mediaItem, com.yuricunha.yumusic.model.Download download) {
    ...
    public void download(List<MediaItem> mediaItems, List<com.yuricunha.yumusic.model.Download> downloads) {
        for (int counter = 0; counter < mediaItems.size(); counter++) {
            download(mediaItems.get(counter), downloads.get(counter));
        }
    }

    public void remove(MediaItem mediaItem, com.yuricunha.yumusic.model.Download download) {
    ...
    public void remove(List<MediaItem> mediaItems, List<com.yuricunha.yumusic.model.Download> downloads) {
        for (int counter = 0; counter < mediaItems.size(); counter++) {
    ...
    public static String getDownloadNotificationMessage(String id) {
        com.yuricunha.yumusic.model.Download download = getDownloadRepository().getDownload(id);
    ...
    private static void insertDatabase(com.yuricunha.yumusic.model.Download download) {
